...
<div class="container">
 <div class="row">
  ...
  {{csrf_field()}}
  <h1>จองตั๋วรถ</h1>
  <h2>เที่ยวรถที่ต้องการเดินทาง</h2> <br>
  <div class="container">
    <div class="row">
        <div class="col-md-2">
            <a href="reserve" class="btn btn-primary btn-lg btn-block btn-huge">เที่ยวเดียว</a>
    ...
    <div class="row"> 
    <div class="col-md-2">
    <label for="date">วันที่ออกเดินทาง : <input type="date" name="date" id="date" class="form-control" required=><br></div></div>
    
    @if(isset($delete) && $delete== 1 )
     <div class="row">
      <div class="col-md-2">
      <label for="date">วันที่เดินทางกลับ : <input type="date" name="date" id="date" class="form-control" required=></div>
     </div>
    @endif
 <br><br>
  <button id="submit" name="submit" class="btn btn-info"><span class="glyphicon glyphicon-search"></span> Search</button>
...
var app = angular.module('app', [], function ($interpolateProvider) {
        ...
        app.controller('form', function ($scope) {
            ...
            $scope.pendways = [
              ...
              {tpye:"ภูเก็ต",name:'สถานีขนส่งผู้โดยสารภูเก็ต แห่ที่ 2'},{tpye:"ภูเก็ต",name:'สถานีขนส่งผู้โดยสารภูเก็ต แห่ที่ 1'},{tpye:"พังงา",name:'สถานีขนส่งผู้โดยสารโคกกลอย'},{tpye:"พังงา",name:'สถานีขนส่งผู้โดยสารพังงา'},
