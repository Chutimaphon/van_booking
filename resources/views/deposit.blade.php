...
<div class="container">
      ...
      <h1>ฝากสิ่งของ</h1>
          ...
          <div class="row bs-wizard" style="border-bottom:0;">
                ...
                <div class="col-xs-3 bs-wizard-step active">
                  ...
                  <div class="bs-wizard-info text-center">ใส่รายละเอียดและ ค้นหาเที่ยวรถ</div>
                </div>
                ...
                <div class="col-xs-3 bs-wizard-step disabled"><!-- complete -->
                  ...
                  <div class="progress"><div class="progress-bar"></div></div>
                  <a href="#" class="bs-wizard-dot"></a>
                  <div class="bs-wizard-info text-center">เลือกเวลาที่จะส่งของ</div>
                </div>
                ...
                <div class="col-xs-3 bs-wizard-step disabled"><!-- complete -->
                  ...
                  <div class="progress"><div class="progress-bar"></div></div>
                  <a href="#" class="bs-wizard-dot"></a>
                  <div class="bs-wizard-info text-center">เลือกประเภทของสิ่งของ</div>
                </div>
  ...
  <form method="post" action="{{url('/depose')}}" role="form" ng-app="app" ng-controller="form">
  {{csrf_field()}}
  <br><br>
<div class="container">
   <div class="row">   
<div class="col-md-4">
   <h2>เที่ยวรถที่ต้องการฝากของ</h2> <br><br></div></div></div>
...
<div class="col-md-6">
      ...
      @endif
      <label for="name">ชื่อสิ่งของ : </label><input type="text" class="form-control" name="item_name" ><br>
      <label for="name">ประเภทสิ่งของ : </label><br>
      <select name="type" class="form-control">
        <option value="1">ซอง</option>
        <option value="2">กล่องขนาด 14 x 20 x 6 cm.</option>
        <option value="3">กล่องขนาด 20 x 30 x 11 cm.</option>
        <option value="4">กล่องขนาด 24 x 40 x 17 cm.</option>
        <option value="5">กล่องขนาด 25 x 30 x 10 cm.</option>
      </select><br>
      <label for="sel1">จำนวนชิิ้น :</label>
      <input type="number" class="form-control" name="amount" ><br>
      <label for="inputdefault">รายละเอียด</label>
      <textarea rows="5" cols="75" id="inputdefault" name="detail" required=""></textarea>
 ...
 <br><br>
       <button id="submit" formaction="depose" name="submit" class="btn btn-info"><span class="glyphicon glyphicon-search"></span> Search</button>
