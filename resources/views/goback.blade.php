...
<div class="container">
  <div class="row">
    <div class="col-md-4">
      <img src="img/van1.png"><br><br>
    </div>
      <div class="col-md-8">
        <center><h2>จองเที่ยวรถ</h2><br><br>   
          <a href="{{url('goback')}}" name="back" id="back" class="btn btn-info">ไป-กลับ</a><br><br>
        <center>
            <form method="post" action="{{url('reservations')}}">
              <div class="form-group">
                <label for="seat">เลขที่นั่ง : <input type="number" name="seat" id="seat" class="form-control" required>
                </label>
